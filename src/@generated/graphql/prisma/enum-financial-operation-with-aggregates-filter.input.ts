...
import { NestedEnumFinancialOperationWithAggregatesFilter } from './nested-enum-financial-operation-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumFinancialOperationFilter } from './nested-enum-financial-operation-filter.input';

@InputType()
export class EnumFinancialOperationWithAggregatesFilter {
